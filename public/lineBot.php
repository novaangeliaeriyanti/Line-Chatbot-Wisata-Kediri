...
class Linebot {
	...
	public function replyCandi($data_kolom1,$data_kolom2,$data_kolom3){
		$api = $this->apiReply;
		$webhook = $this->webhookEventObject;
		$replyToken = $webhook->{"events"}[0]->{"replyToken"}; 
		$body["replyToken"] = $replyToken;
	...
	public function replyGunung($data_kolom1,$data_kolom2){
		$api = $this->apiReply;
		$webhook = $this->webhookEventObject;
		$replyToken = $webhook->{"events"}[0]->{"replyToken"}; 
		$body["replyToken"] = $replyToken;
	...
	public function replyAir($data_kolom1,$data_kolom2,$data_kolom3,$data_kolom4){
		$api = $this->apiReply;
		$webhook = $this->webhookEventObject;
		$replyToken = $webhook->{"events"}[0]->{"replyToken"}; 
		$body["replyToken"] = $replyToken;
